...
const Item = (props) => {
    return (
        <View style={styles.item}>
            ...
            >
                <Text style={{ color: "white", fontWeight: "bold"}}>Ištrinti</Text>
            </MainauButton>
        </View>
    )
}
...
const Categories = (props) => {
    ...
    useEffect(() => {
        ...
        .catch((error) => alert("Klaida gaunant kategorijas"))
            ...
            <View style={styles.bottomBar}>
                ...
                <View>
                    <MainauButton
                        ...
                        onPress={() => addCategory()}
                    >
                        <Text style={{ color: "white", fontWeight: "bold" }}>Pridėti</Text>
                    </MainauButton>
                </View>
            </View>
        </View>

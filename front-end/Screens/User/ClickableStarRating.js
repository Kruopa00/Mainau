      ...
      <View style={styles.container}>
        <View style={styles.stars}>
          <TouchableWithoutFeedback
            ...
            onPress={() => [setStarRating(1), selectionCallback(1)]}
          >
          ...
          <TouchableWithoutFeedback
            onPressIn={handlePressIn}
            onPressOut={handlePressOut}
            onPress={() => [setStarRating(2), selectionCallback(2)]}
          >
            <Animated.View style={animatedScaleStyle}>
              <MaterialIcons
          ...
          <TouchableWithoutFeedback
            onPressIn={handlePressIn}
            onPressOut={handlePressOut}
            onPress={() => [setStarRating(3), selectionCallback(3)]}
          >
            <Animated.View style={animatedScaleStyle}>
              <MaterialIcons
          ...
          <TouchableWithoutFeedback
            onPressIn={handlePressIn}
            onPressOut={handlePressOut}
            onPress={() => [setStarRating(4), selectionCallback(4)]}
          >
            <Animated.View style={animatedScaleStyle}>
              <MaterialIcons
          ...
          <TouchableWithoutFeedback
            onPressIn={handlePressIn}
            onPressOut={handlePressOut}
            onPress={() => [setStarRating(5), selectionCallback(5)]}
          >
            <Animated.View style={animatedScaleStyle}>
              <MaterialIcons
